...
Caractéristiques :
1. Une histoire avec plusieurs choix influençant l’aventure.
2. Caractéristiques pour le joueur : Force, Endurance, Intelligence, et Maniement des Armes.
3. Des choix accessibles uniquement si les caractéristiques nécessaires sont respectées.
4. Finalité multiple basée sur les décisions du joueur.
...
1. Charger le fichier texte correspondant à la langue choisie (français ou anglais).
2. Suivre les choix proposés dans le jeu.
3. Attention : Certains choix nécessitent des caractéristiques spécifiques. Si vous ne remplissez pas les conditions, le choix ne sera pas disponible.
4. Progressez à travers les niveaux jusqu’à atteindre l’un des dénouements possibles.

Pré-requis techniques :
1. Système d’exploitation : Windows, Linux ou macOS.
2. Un compilateur C (par exemple : GCC ou MinGW).
3. Un terminal ou une console pour exécuter le jeu.
